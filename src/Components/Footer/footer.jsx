...
export default function Footer() {
  ...
  return (
    <div className="flex px-2 items-center text-xs md:sm lg:text-lg w-[80%] md:w-1/2 lg:w-1/3 bg-[rgba(255,255,255,.5)] backdrop-blur-sm shadow-lg shadow-gray-300 border-[1px] border-b-0 border-gray-300 fixed h-[40px] md:h-[50px] lg:h-[60px] bottom-0 justify-evenly gap-5">
        <Link 
